...
# h1 <-> h3 via s1 -> s3 -> s4
$OFCTL add-flow s1 \
  "idle_timeout=0,ip,in_port=1,nw_src=10.0.0.1,nw_dst=10.0.0.3,actions=output:3"
$OFCTL add-flow s1 \
  "idle_timeout=0,ip,in_port=3,nw_src=10.0.0.3,nw_dst=10.0.0.1,actions=output:1"
...
$OFCTL add-flow s4 \
  "idle_timeout=0,ip,in_port=3,nw_src=10.0.0.1,nw_dst=10.0.0.3,actions=output:1"
$OFCTL add-flow s4 \
  "idle_timeout=0,ip,in_port=1,nw_src=10.0.0.3,nw_dst=10.0.0.1,actions=output:3"

echo "Reference rules installed."
