...
Through a combination of lectures and hands-on labs, participants will explore programmable forwarding using **Open vSwitch** and **Mininet**, and centralized control using the **ONOS SDN controller**, demonstrating how network paths can be dynamically configured and managed.
